...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/styles/pageUpdate/pageUpdate.css" />
    ...
    <script>
        window.onload = () => {
            ...
            setting_opt.addEventListener("click", () => {
                ...
                setting_opt.classList.add("active")
            ...
            add_video_opt.addEventListener("click", () => {
                ...
                add_video_opt.classList.add("active")
