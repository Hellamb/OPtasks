...
<body>
    <div class="content">
        <form action="${pageContext.request.contextPath}/result" class="form" method="post">
            <div class="inputs">
                <div class="parameters">
                    <input name="a" value="${cookie['parameterA'].value}" required placeholder="a"/>
                    <input name="b" value="${cookie['parameterB'].value}" required placeholder="b"/>
                    <input name="c" value="${cookie['parameterC'].value}" required placeholder="c"/>
                    <input name="d" value="${cookie['parameterD'].value}" required placeholder="d"/>
                </div>
                <div class="equation">
